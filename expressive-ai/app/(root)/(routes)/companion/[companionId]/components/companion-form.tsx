              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input
                      disabled={isLoading}
                      placeholder="A Wizard from Gryffindor House Attributes: Bravery, courage, chivalry House Positions: Quidditch Seeker..."
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormDescription>
                  Describe in detail your companion&apos;s conversation and
                  relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
